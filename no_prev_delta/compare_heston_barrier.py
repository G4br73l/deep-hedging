...
LOG_PATH    = os.path.join(RESULTS_DIR, "barrier_log.txt")
...
N_FEATURES    = 5          # feature dimension (see build_barrier_feature_matrix)
...
def main():
    ...
    # -----------------------------------------------------------------------
    print("\n[3] Building feature matrices (5 features) ...")
    ...
    # -----------------------------------------------------------------------
    print("\n[7] Saving results ...")
    results_path = os.path.join(RESULTS_DIR, "barrier_results.pt")
    torch.save({
    ...
    json_path = os.path.join(RESULTS_DIR, "barrier_summary.json")
    ...
    plot_distribution(
        gains_dict, premium,
        os.path.join(FIGURES_DIR, "barrier_gain_distributions.pdf"),
    )
    plot_decomposition(
        components_dict, premium,
        os.path.join(FIGURES_DIR, "barrier_gain_decomposition.pdf"),
    )
    plot_convergence(
        history_dict = {
        ...
        save_path  = os.path.join(FIGURES_DIR, "barrier_cvar_convergence.pdf"),
    )
